...
// Custom Predicate derived from UserPredicateT to peel off
// bad shaped border triangles
class Decider:public UserPredicateT
{
public:
...
int cutAndFill_main()
{
	...
	Decider decider;
	Zone2* pZoneBefore=peelOffIf(pZoneBeforeRaw,&decider,false);
	Zone2* pZoneAfter=peelOffIf(pZoneAfterRaw,&decider,false);
