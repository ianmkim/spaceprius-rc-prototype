 ...
 * difference is hardly noticeable and only relevant in scientific
 * applications, while practical applications may want to skip the
 * computationally expensive calculations.
 *
 * Depending on the position of the input points, the effect of the
 * FastMode is between zero and a quite considerable acceleration.
 *
 * @param bFast is true when exact tests shall be avoided in favor
